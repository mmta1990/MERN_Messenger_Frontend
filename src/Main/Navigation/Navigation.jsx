    ...
    return (
        <nav className="navigation">
            <div className="container">
                <a href="https://miladtaghipour.ir/" target="_blank" className="logo" rel="home noopener noreferrer">
                    <Logo />
                </a>
...
export default connect(
    state => ({ me: state.main.me }),
    dispatch => ({ logout: payload => dispatch({ type: mainActions.LOGOUT_REQUESTED, payload }) })
)(Navigation);