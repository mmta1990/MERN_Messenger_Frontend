                ...
                <div className="middle">
                    ...
                    <ul className="notifications">
                        <li>
                            ...
                            <p>معین پوران تیوش به گروه <strong>BI</strong> پیوست.</p>
                        </li>
                        <li>
                            ...
                            <p>به دلایل امنیتی باید رمز عبور خود را تغییر دهید.</p>
                        </li>
                        <li>
                            ...
                            <p>میلاد تقی پور فایل <strong>Messenger.js</strong> را پیوست کرد.</p>
                        </li>
                        <li>
                            ...
                            <p>امروز تولد یزدان خوش چهره است، بهترین ها رو برای او آرزو کنید.</p>
                        </li>
                        <li>
                            ...
                            <p>علی معصومی درخواست دوستی شما را پذیرفته است.</p>
                        </li>
                    </ul>
                </div>
            </div>
