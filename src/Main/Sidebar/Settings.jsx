                                    ...
                                    <div className="form-row">
                                        <div className="col-sm-6">
                                            <div className="form-group">
                                                <label>نام </label>
                                                <input type="text" name="firstName" id="firstName" className="form-control" placeholder="نام" defaultValue="میلاد" />
                                            </div>
                                        </div>
                                        <div className="col-sm-6">
                                            <div className="form-group">
                                                <label>نام خانوادگی</label>
                                                <input type="text" className="form-control" placeholder="نام خانوادگی" defaultValue="تقی پور" name="lastName" id="lastName" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="form-group">
                                        <label>ایمیل</label>
                                        <input type="email" className="form-control" placeholder="آدرس ایمیل خود را وارد کنید" name="email" id="email" defaultValue="miladtaghipour1369@gmail.com" />
                                    </div>
                                    <div className="form-group">
